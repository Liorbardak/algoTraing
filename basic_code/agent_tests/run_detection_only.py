...
def run_detection_only(prompt_detection_path , target_tickers , results_path):
    '''
    Run detection process using the prompt stored in prompt_detection_path on the target tickers  list
    :param prompt_detection_path:  prompt stored in prompt_detection_path
    :param target_tickers: target tickers  list
    :return: store results on results_path , return the results_path
    '''
    import time
...
def main():
    ...
    results_path = os.path.join('results',  f"results_{timestamp}")
    evaluation_path = os.path.join('results',  f"results_{timestamp}")
    ...
    run_evaluation(tickers=target_tickers,resdir=results_path  , outputdir= evaluation_path)
